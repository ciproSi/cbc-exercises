...
class Snail {
    ...
    render(position) {
      ...
      document.addEventListener('keydown', (e) => {
        if (e.code === "Space") {
          ...
          this.positionOfSnail = 0;
          this.interval = setInterval(() => {
            snailElm.style = `
              left: ${this.positionOfSnail += this.speed / 20}px;
              top: ${position * 150}px;
              `;
            if (this.positionOfSnail >= screen.width - 180) {clearInterval(this.interval)};
          }, 50);
    ...
    mount(parent,position) {
      this.element = this.render(position);
